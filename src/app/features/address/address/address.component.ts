...
import { AddressDashboardWidgetComponent } from '../address-dashboard-widget/address-dashboard-widget.component';
@Component({
  selector: 'app-address',
  imports: [CommonModule,FullpageLoaderComponent,DeleteConfirmComponent,
